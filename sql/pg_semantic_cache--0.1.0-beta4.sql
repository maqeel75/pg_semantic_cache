-- pg_semantic_cache--0.1.0-beta4.sql
-- This is a direct installation of version 0.1.0-beta4
-- (includes all features from 0.1.0-beta3 plus implemented cache_hit_rate() and auto_evict())

-- This file is identical to 0.1.0-beta3.sql since init_schema() creates all tables
-- The difference is that 0.1.0-beta4 implements cache_hit_rate() and auto_evict() as real SQL functions
